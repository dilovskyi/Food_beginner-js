...
function cards() {
  // classCards
  var MealCard = /*#__PURE__*/function () {
    function MealCard(img, alt, title, descr, price, parent) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              throw new Error("\u041E\u0448\u0438\u0431\u043A\u0430 \u0441\u043E \u0441\u0442\u0430\u0442\u0443\u0441\u043E\u043C ".concat(res.status, ",\u041D\u0435 \u0441\u043C\u043E\u0433\u043B\u0438 \u043E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u0442\u044C \u0437\u0430\u043F\u0440\u043E\u0441 \u043D\u0430 ").concat(url));
...
function forms(modaltimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", function (e) {
      ...
      var formData = new FormData(form); // Новый способ

      var json = JSON.stringify(Object.fromEntries(formData.entries())); // старый способ
...
function slider() {
  ...
  var currentNum = document.querySelector("#current"),
      ...
      sliderElem = document.querySelectorAll(".offer__slide"),
      slidesWrapper = document.querySelector(".offer__slider-wrapper"),
      slidesField = document.querySelector(".offer__slider-inner"),
      width = window.getComputedStyle(slidesWrapper).width,
      fieldWidth = sliderElem.length * parseInt(width, 10);
  /* total 2600px */

  var translated = 0;
  var index = 1;
  currentNum.innerHTML = "0".concat(index);

  if (sliderElem.length < 10) {
    totalNum.innerHTML = "0".concat(sliderElem.length);
  } else {
  ...
  function changeNum(i) {
    if (index < 10) {
      currentNum.innerHTML = "0".concat(i);
    } else {
      currentNum.innerHTML = i;
    }
  }

  slidesField.style.cssText = "display: flex; width: ".concat(fieldWidth, "px");
  ...
  function next() {
    ...
    slidesField.style.transform = "translateX(-".concat(translated, "px)");
    changeDot();
    changeNum(index);
  }
  ...
  for (var i = 1; i <= sliderElem.length; i++) {
  ...
  function changeDot() {
    dotsArr.forEach(function (item, i) {
  ...
  dotsArr.forEach(function (item) {
    item.addEventListener("click", function (e) {
      ...
      slidesField.style.transform = "translateX(-".concat(translated - parseInt(width, 10), "px)");
      changeDot();
      changeNum(index);
    });
  });
...
function timer() {
  //timer
  var deadline = "2021-05-27T00:00:00.000";
